...
*User authentication (Sign Up, Sign In, Password Reset) as shown in the UI mockups will be integrated via AWS Cognito or a dedicated Auth Service in a subsequent phase.*

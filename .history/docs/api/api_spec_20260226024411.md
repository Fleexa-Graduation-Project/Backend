...
Sends an instruction to an actuator (e.g., locking a door, changing A/C temperature). This writes to the `Fleexa_Commands` table, which the IoT system uses to message the physical device.

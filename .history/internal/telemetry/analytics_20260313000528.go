...
// Calculate24hStats strictly calculates Min/Max/Avg for the last 24 hours of real-time
func Calculate24hStats(history []models.Telemetry, metric string) (BasicStats, error) {
	if len(history) == 0 {
		return BasicStats{}, fmt.Errorf("no data")
	}
	...
	if overallCount == 0 {
		return BasicStats{Min: 0, Max: 0, Average: 0}, nil
	}

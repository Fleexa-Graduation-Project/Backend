...
// CalculateTempStats strictly calculates Min/Max/Avg for the last 24 hours of real-time
func CalculateTempStats(history []models.Telemetry, metric string) (TempState, error) {
	if len(history) == 0 {

...
// ChartPoint represents a generic X/Y coordinate for the Flutter UI charts
type ChartPoint struct {
	Label string  `json:"label"` // x-axis (e.g., "10:00", "2026-03-01")
	Value float64 `json:"value"` // y-axis (e.g., 29.5 temp, or 4.2 hours)
}
...
func AggregateTimeSeries(history []models.Telemetry, metric string, period string) []ChartPoint {
	...
	// Sort chronologically (oldest to newest) so the chart draws left-to-right

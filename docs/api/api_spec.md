      ...
      "data": [
        {
          ...
          "type": "sensor",
          "status": "ONLINE",
          "current_state": { "temp": 29.0, "status": "WARM" },
        ...
        },
        {
          ...
          "type": "actuator",
          "status": "ONLINE",
          "current_state": { "power": "ON", "target_temp": 24.0, "mode": "COOLING" },
          "last_seen_at": 1708434000
        }
      ]
    }
...
*User authentication (Sign Up, Sign In, Password Reset) will be integrated via AWS Cognito or a dedicated Auth Service.*
